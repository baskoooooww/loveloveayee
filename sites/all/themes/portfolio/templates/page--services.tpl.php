  ...
  <main role="main" class="l-main">
    <div class="<?php print $main_grid; ?> main">
     ...
     <!-- <?php if ($breadcrumb): print $breadcrumb; endif; ?> -->
      ...
      <!--   <div class="date"><?php print format_date(time(), 'custom', 'F j, Y'); ?></div> -->
...
<!--  <div class=""><a href="http://kim.com"><img src="/sites/default/files/kimkom.png"></a></div> -->
    <?php if (!empty($page['footer'])): ?>
      <div class="footer large-12 center columns">
        <?php print render($page['footer']); ?>

         <?php if ($site_name) :?>
      <div class="copyright large-12 columns">
       <a href="https://globaledge-media.com" target="_blank">Design and Developed by GlobalEdge Media Solutions Inc.</a>
      </div>
    <?php endif; ?>
      </div>
    <?php endif; ?>
